// winmux-tools statusline module: session Ticker (GitHub issue #4).
...
// (../hooks/turn-state.js) into ~/.claude/winmux-tools/turn-state/<sid>.json.
// Toggle with WINMUX_TICKER=0.
// Contract: module.exports = (data, cfg) => string
const fs = require('fs');
const os = require('os');
const path = require('path');

const STATE_DIR = path.join(os.homedir(), '.claude', 'winmux-tools', 'turn-state');
