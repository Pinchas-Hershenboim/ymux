...
export function WinmuxToolsTab(p: { workspaceId?: string }) {
  ...
  return (
    <section>
      <h4>winmux-tools · Skills</h4>
      <p class="settings-hint">
        Skills in your local registry (config dir → winmux-tools/skills/). Install them
      ...
      <Show when={skills().length === 0 && !loading()}>
        <p class="settings-hint">
          No skills in the registry yet — drop a skill folder into winmux-tools/skills/.
        </p>
      </Show>
