...
///
/// The push carries `pane_id` from the hook process's `WINMUX_PANE_ID`
...
/// attached to a tmux session name. Covers WSL panes too: Phase 80 gave
/// `LocalSession` a `tmux_session` as well.
