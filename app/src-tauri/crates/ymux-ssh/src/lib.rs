...
//! originally targeted for `ymux-ssh` (`connect_and_authenticate`,
...
//!
//! No AppState, no tauri. Depends on `ymux-core` for `SshClient` +
...
use ymux_core::{log_debug, log_error, log_warn, SshClient};
