...
// CI with a JDK). Verifies the generated YmuxFrame sealed type + DTOs
// round-trip real ymux-server wire payloads. The full REST/WS wire contract
...
class ContractTest {
    ...
    fun `REST DTOs round-trip`() {
        val v = json.decodeFromString(
            ...
            """{"name":"ymux-server","version":"2.0.0","api_versions":[2],"frame_version":2}""",
        )
        assertEquals("ymux-server", v.name)
